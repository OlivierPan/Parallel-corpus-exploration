#coding:utf-8
# This is a advanced crawler, could be a basic model for futur use.
import requests
import lxml
import re
import datetime
...
def requestnew(url):
	...
	return titre,texte,titre2,texte2 # in order, the french article title, content, the chinese article title, content
...
#In the end, we have a document XML containing all the article found on the web page
